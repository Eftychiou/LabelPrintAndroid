...
//	static void showUsbDialog(final Context context, final Set<UsbDevice> usbDevices, final BroadcastReceiver
//	usbReceiver) {
//		final String[] items = new String[usbDevices.size()];
//		int index = 0;
//		for (UsbDevice device : usbDevices) {
//			items[index++] = "Device name: " + device.getProductName() + ", Product ID: " + device.getProductId() + ",
...
//                        .setItems(items, new OnClickListener() {
//                            public void onClick(DialogInterface dialog, int which) {
//                                MainActivity.mBixolonLabelPrinter.connect(items[which].split(":")[0],
//                                        Integer.valueOf(items[which].split(":")[1]), 5000);
//                            }
//                        }).show();
...
//                            } else if (which == 1) {
//                                printer.getPrinterInformation(BixolonLabelPrinter
//                                .PRINTER_INFORMATION_FIRMWARE_VERSION);
//                            }
//                        }
//                    }).create();
//        }
//        dialog.show();
//    }
//    private static final int mmCheckedItem = 0;
...
//                                if (string1 != null && string1.length() > 0 && string2 != null && string2.length()
//                                > 0) {
...
//                                    }
//                                    MainActivity.mBixolonLabelPrinter.setLength(labelLength, gapLength, mediaType,
//                                            offsetLength);
//                                }
//                            } catch (Exception e) {
...
//                    .setSingleChoiceItems(new String[]{"Print from top to bottom (default)", "Print from bottom to " +
//                            "top"}, 0, new OnClickListener() {
//                        public void onClick(DialogInterface arg0, int arg1) {
//                            mmCheckedItem = arg1;
//                        }
//                    }).setPositiveButton("OK", new OnClickListener() {
//                        public void onClick(DialogInterface dialog, int which) {
//                            if (mmCheckedItem == 0) {
//                                MainActivity.mBixolonLabelPrinter.setOrientation(BixolonLabelPrinter
...
//                                MainActivity.mBixolonLabelPrinter.setAutoCutter(radioGroup.getCheckedRadioButtonId
//                                () == R.id.radio0, cuttingPeriod);
//                            } catch (Exception e) {
//                                Toast.makeText(context, "please input data", Toast.LENGTH_SHORT).show();
//                            }
//                        }
...
//            ArrayAdapter<String> adapter = new ArrayAdapter<>(context, R.layout.layout_textview,
//                    context.getResources().getStringArray(R.array.arr_rfid_transponder_type));
...
//                                MainActivity.mBixolonLabelPrinter.setupRFID(rfidType, numberOfRetries, numberOfLabel,
//                                        radioPower);
//                            } catch (Exception e) {
//                                Toast.makeText(context, "please input data", Toast.LENGTH_SHORT).show();
//                            }
...
//            ArrayAdapter<String> adapter = new ArrayAdapter<>(context, R.layout.layout_textview,
//                    context.getResources().getStringArray(R.array.arr_rfid_data_type));
//            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
...
//                        public void onClick(DialogInterface dialog, int which) {
//                            try {
//                                MainActivity.mBixolonLabelPrinter.drawText("RFID Test Print", 50, 50,
...
//                                    MainActivity.mBixolonLabelPrinter.setRFIDPassword(oldAccessPW, oldKillPW,
//                                            newAccessPW, newKillPW);
//                                }
//                                if (dataType == 'E') {
...
//                                MainActivity.mBixolonLabelPrinter.writeRFID(dataType, startingBlockNumber, dataLength,
//                                        data);
...
//                                MainActivity.mBixolonLabelPrinter.setRFIDPassword(oldAccessPwd, oldKillPwd,
//                                        newAccessPwd, newKillPwd);
//                            } catch (Exception e) {
//                                Toast.makeText(context, "please input data", Toast.LENGTH_SHORT).show();
//                            }
//                        }
